        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <a href="/legal/terms" className="text-slate-600 hover:text-blue-600 block">Terms of Service</a>
              <a href="/legal/privacy" className="text-slate-600 hover:text-blue-600 block">Privacy Policy</a>
              <a href="/legal/cookies" className="text-slate-600 hover:text-blue-600 block">Cookie Policy</a>
              <a href="/legal/disclaimer" className="text-slate-600 hover:text-blue-600 block">AI Disclaimer</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <a href="/compliance" className="text-slate-600 hover:text-blue-600 block">DNC Management</a>
              <a href="/legal/tcpa" className="text-slate-600 hover:text-blue-600 block">TCPA Compliance</a>
              <a href="/legal/gdpr" className="text-slate-600 hover:text-blue-600 block">GDPR Rights</a>
              <a href="/legal/casl" className="text-slate-600 hover:text-blue-600 block">CASL Compliance</a>
            </div>
          </div>
